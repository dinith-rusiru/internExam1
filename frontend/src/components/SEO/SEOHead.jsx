...
export const SEOConfigs = {
  ...
  login: {
    ...
    description: "Secure login to AdminHub admin panel. Access your dashboard with role-based authentication and manage users with advanced security features.",
    keywords: "login, admin login, secure authentication, admin access, user authentication, dashboard login",
  },
  register: {
    title: "Register - AdminHub | Create Admin Account",
    description: "Create your AdminHub account to access the modern admin panel. Get started with user management, secure authentication, and powerful dashboard features.",
    keywords: "register, create account, admin registration, signup, new user, admin panel access",
  },
  dashboard: {
    title: "Dashboard - AdminHub | Admin Control Panel",
    description: "AdminHub dashboard overview with user statistics, account information, and quick actions. Monitor and manage your admin panel efficiently.",
    keywords: "dashboard, admin dashboard, control panel, user statistics, admin overview, management panel",
    noIndex: true, // Dashboard should not be indexed as it requires authentication
  },
  users: {
    title: "User Management - AdminHub | Manage Users",
    description: "Comprehensive user management system in AdminHub. View, edit, delete users, manage roles, and control access permissions with advanced admin tools.",
    keywords: "user management, manage users, user roles, admin tools, user permissions, user control",
